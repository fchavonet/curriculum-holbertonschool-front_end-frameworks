...
Set up the initial **Vue.js** application using **Vite**.

The goal of this task is to create a **clean Vue.js project foundation** that will be used for all the following tasks.

This task **intentionally follows the same principles** and overall workflow as the **project setup task from the previous React project**. You will go through a very similar setup process while discovering how the Vue.js ecosystem approaches project initialization, configuration and tooling.

---

- Create a Vue.js project with Vite in the `front_end-frameworks/vue/` directory.
    - Use the **Vue** framework and the **JavaScript** variant during the project initialization.

<table align="center">
    <tr valign="top">
        <td align="center">
            <img width="100%" src="../assets/images/screenshots/vue-vite.webp">
        </td>
        <td align="center">
...
- The final project configuration must allow:
    ...
    - Lucide Vue to be used inside components.
...
- Create a **temporary homepage** in `src/App.vue`.
    - The homepage must contain:
        - A main title (`h1`).
        - A short subtitle (`h2`).
        - At least one Lucide Vue icon.
