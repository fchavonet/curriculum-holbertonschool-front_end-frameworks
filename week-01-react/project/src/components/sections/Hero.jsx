...
function Hero() {
  return (
    <section id="hero-section" className="relative pt-36 pb-24 flex flex-col justify-center items-center border-b border-slate-900 bg-slate-950 overflow-hidden">
